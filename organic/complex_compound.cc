...
void organic::complex_compound::set_bond_type(size_t index, utils::ranged_numeric<int, 1, 3> value) {
...
void organic::complex_compound::add_group(size_t index, std::function<group *()> factory) {
...
void organic::complex_compound::remove_group(size_t index, size_t group) {
